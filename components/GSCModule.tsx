...
import {
  ...
  Target, Zap, ExternalLink, ChevronDown, ChevronUp, Info, AlertCircle,
} from 'lucide-react';
          ...
          <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-2xl">
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-amber-600 mt-1">{t('gsc', 'errorHint', lang)}</p>
                <button onClick={fetchData} className="mt-2 text-xs font-bold text-amber-700 underline hover:text-amber-900">
                  {t('common', 'retry', lang)}
                </button>
              </div>
            </div>
