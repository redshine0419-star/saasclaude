...
| 유료 전환 목표 | MAU 1,000 → 유료 전환 5% (50명) |
...
### Phase 3 — Monetization (예정)

- **Freemium 플랜**: 월 5회 진단 무료, 무제한 유료
- **Team 플랜**: 멤버 초대, 프로젝트 공유, 권한 관리
- **API 플랜**: 리포트 API 엔드포인트 제공 (에이전시 화이트라벨)
- **Vercel AI Gateway 연동**: 멀티 모델 fallback, 비용 모니터링
